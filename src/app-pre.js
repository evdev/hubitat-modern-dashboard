...
// Simple blue lock icons for the lock favorite tile (tinted via currentColor).
// Closed shackle = locked, open shackle = unlocked.
const LOCK_CLOSED_SVG = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.5 11V7.5a3.5 3.5 0 0 1 7 0V11" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><rect x="5" y="11" width="14" height="9" rx="2.4" fill="currentColor"/></svg>';
const LOCK_OPEN_SVG = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.5 11V7.5a3.5 3.5 0 0 1 6.5-1.2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><rect x="5" y="11" width="14" height="9" rx="2.4" fill="currentColor"/></svg>';
