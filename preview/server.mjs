...
function buildMockData(count) {
  ...
  const thermostats = [
    ...
    { i: 1003, n: "Office Thermostat", r: 4, tm: "off", os: "idle", hsp: 65, csp: 75, temp: 70, u: "F", hasFm: 1, fm: "circulate", hasFs: 0, fs: null, supM: "heat,cool,off", supFM: "auto,circulate", fsLev: null },
  ];
  const tempSensors = [
