(() => {
  ...
  function getDisplayRoomIds(groups, hasContent) {
    ...
    const hasUnassigned = groups.has(-1) || (outletsInLightsRooms() && M.outletsByRoom.has(-1)) || M.roomHasClimate(-1);
    let order;
