...
def renderIndex() {
    ...
    def iconHref = "https://raw.githubusercontent.com/evdev/hubitat-modern-dashboard/beta/dist/upload/mld-icon-192-0.3.93.png"
...
def renderManifest() {
    ...
    for (def size : ["192", "512", "1024"]) {
        def src = "https://raw.githubusercontent.com/evdev/hubitat-modern-dashboard/beta/dist/upload/mld-icon-${size}-0.3.93.png"
