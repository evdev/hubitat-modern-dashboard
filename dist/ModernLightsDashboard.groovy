...
@Field private static final String MLD_DEPLOYED_VERSION = "0.3.96"
...
def mainPage() {
    ...
    dynamicPage(name: "mainPage", uninstall: true, install: true) {
        section("About Modern Dashboard", hideable: true, hidden: true) {
            ...
            paragraph "<small>Version 0.3.96 · Ephrayim (evdev) · Apache License 2.0 · <a href='https://github.com/evdev/hubitat-modern-dashboard' target='_blank'>Source</a></small>"
        }
        if (assetsOk) {
...
def renderIndex() {
    ...
    def iconHref = "https://raw.githubusercontent.com/evdev/hubitat-modern-dashboard/beta/dist/upload/mld-icon-192-0.3.96.png"
...
def renderManifest() {
    ...
    for (def size : ["192", "512", "1024"]) {
        def src = "https://raw.githubusercontent.com/evdev/hubitat-modern-dashboard/beta/dist/upload/mld-icon-${size}-0.3.96.png"
