...
//        mld-index.html, mld-app.css, mld-app-pre.js, mld-app.js, mld-app-post.js, mld-app-post2.js,
...
def mainPage() {
    ...
    dynamicPage(name: "mainPage", uninstall: true, install: true) {
        section("About Modern Dashboard", hideable: true, hidden: false) {
            ...
            paragraph "<small>Version 0.1.8 · Ephrayim (evdev) · Apache License 2.0 · <a href='https://github.com/evdev/hubitat-modern-dashboard' target='_blank'>Source</a></small>"
        }
        section("Devices") {
...
def requiredAssetFiles() {
    return [
        assetHtmlFile(), assetCssFile(), assetJsPreFile(), assetJsFile(), assetJsPostFile(), assetJsPost2File(),
